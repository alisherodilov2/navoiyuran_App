...
import 'package:test/pages/Labaratoriya/SampleActivatedShow.dart';
import 'package:test/pages/role/Dispatcher/ActivePageShow.dart';

class LabaratoryActiveSample extends StatefulWidget {
  const LabaratoryActiveSample({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() => _QRViewExampleState();
}

class _QRViewExampleState extends State<LabaratoryActiveSample> {
  @override
  void initState() {
    super.initState();
  }
    ...
    controller.scannedDataStream.listen((scanData) {
      setState(() {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (BuildContext context) => SampleActivated(id: id),
          ),
        ).then((_) {
