    ...
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        builder: (context, snapshot) {
          if (snapshot.hasData) {
            List<qrCodeShow> qrCodeData = snapshot.data as List<qrCodeShow>;
                  ...
                  children: [
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(qrcode.sampleGroup!.order!.area.toString())
                              ],
                            ),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                ...
                                Text(qrcode.geoNumber.toString())
                              ],
                            ),
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Analiz turlari:"),
                                Text(qrcode.sampleGroup!.analiz.toString()),
                              ],
                            )
                          ],
                        ),
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children:
                              qrcode.sampleGroup!.order!.samples!.map((e) {
                            return Column(
                              children: [
                                Row(
                                  mainAxisAlignment:
